...
<?
	...
	*/
    ...
    for ($i = 0; $i < $num; $i++)
    {
		...
		$paths[] = mysql_result($result, 0, 'path') . 'new/'; // Mine had to be modified to cur/ since my server was moving files from new/ to cur/ right away.
    }
